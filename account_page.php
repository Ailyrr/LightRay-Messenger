...
$sql = "SELECT * FROM mes_users WHERE U_ID = '$Username_Session'";
...
<html>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
        ...
        <title>LightRay | Mon Compte</title>
    ...
    <div class="profile">
        <div class="profile-header">
            ...
            <div class="nom"><?=$_SESSION['Username'] ?></div>
            ...
            <form class="justify-content-center" method="post">
                <input name ="settings" class="btn" type="submit" value="Paramètres" style="border: 0;
    background: none;
    ...
    " onmouseover="this.style.backgroundColor='#2ecc71'" onmouseout="this.style.backgroundColor='#2c3a47'"/><br>
                <input name="back" type="submit" class="btn" value="Retour" style="border: 0;
    background: none;
   ...
   "  onmouseover="this.style.backgroundColor='#2ecc71'" onmouseout="this.style.backgroundColor='#2c3a47'"/><br>
                <input name="logout" type="submit" class="btn" value="Log Out" style="border: 0;
    background: none;
